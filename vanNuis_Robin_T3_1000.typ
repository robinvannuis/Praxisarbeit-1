...
#figure(
  image("/assets/Scalar Function Query.png", width: 100%),
...
Trotz dieser Herausforderungen konnte ich ein funktionierendes System erstellen, welches die Anforderungen des Projektes erfüllt.

Für zukünftige Ausarbeitungen des System  kann es sinnvoll sein, den Prozess der Datenspeicherung zu optimieren, um die Limitierung der Datenmenge entfernen zu können. Außerdem können weitere Tabellen und Objekttypen in das System integriert werden, um nicht nur den Teams rund um die ABAP #CDS#"s" Einblicke in die Objektnutzung zu geben, sondern auch anderen Teams und Abteilungen innerhalb des Unternehmens.